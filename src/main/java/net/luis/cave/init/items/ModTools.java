...
import net.luis.cave.client.render.item.item.DiamondShieldRender;
import net.luis.cave.client.render.item.item.EnderiteShieldRender;
import net.luis.cave.client.render.item.item.GoldenShieldRender;
import net.luis.cave.client.render.item.item.IronShieldRender;
import net.luis.cave.client.render.item.item.NetheriteShieldRender;
import net.luis.cave.client.render.item.item.NightShieldRender;
