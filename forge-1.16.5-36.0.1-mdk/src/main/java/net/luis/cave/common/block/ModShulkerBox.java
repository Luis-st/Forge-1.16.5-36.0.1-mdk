...
public class ModShulkerBox extends ShulkerBoxBlock {
	...
	public ModShulkerBox(@Nullable DyeColor color, AbstractBlock.Properties properties) {
	...
	public TileEntity createNewTileEntity(IBlockReader worldIn) {
		...
		return new ModShulkerBoxTileEntity(this.getColor());
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
		...
		if (worldIn.isRemote) {
			...
			if (tileentity instanceof ModShulkerBoxTileEntity) {
				...
				if (shulkerboxtileentity.getAnimationStatus() == ModShulkerBoxTileEntity.AnimationStatus.CLOSED) {
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, LivingEntity placer, ItemStack stack) {
		...
		if (stack.hasDisplayName()) {
			...
			if (tileentity instanceof ModShulkerBoxTileEntity) {
				...
				((ModShulkerBoxTileEntity) tileentity).setCustomName(stack.getDisplayName());
	...
	public VoxelShape getShape(BlockState state, IBlockReader worldIn, BlockPos pos, ISelectionContext context) {
		...
		return tileentity instanceof ModShulkerBoxTileEntity
				? VoxelShapes.create(((ModShulkerBoxTileEntity) tileentity).getBoundingBox(state))
	...
	public ItemStack getItem(IBlockReader worldIn, BlockPos pos, BlockState state) {
		...
		ModShulkerBoxTileEntity shulkerboxtileentity = (ModShulkerBoxTileEntity) worldIn.getTileEntity(pos);
		CompoundNBT compoundnbt = shulkerboxtileentity.saveToNbt(new CompoundNBT());
		if (!compoundnbt.isEmpty()) {
			itemstack.setTagInfo("BlockEntityTag", compoundnbt);
		}
	...
	public static DyeColor getColorFromBlock(Block blockIn) {
		...
		return blockIn instanceof ModShulkerBox ? ((ModShulkerBox) blockIn).getColor() : null;
