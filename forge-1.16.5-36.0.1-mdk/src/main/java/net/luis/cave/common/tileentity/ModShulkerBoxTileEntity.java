...
public class ModShulkerBoxTileEntity extends LockableLootTileEntity implements ISidedInventory, ITickableTileEntity {
	...
	public ModShulkerBoxTileEntity(@Nullable DyeColor colorIn) {
		...
		super(ModTileEntityType.SHULKER.get());
		this.color = colorIn;
	...
	public void tick() {
		...
		if (this.animationStatus == ModShulkerBoxTileEntity.AnimationStatus.OPENING
