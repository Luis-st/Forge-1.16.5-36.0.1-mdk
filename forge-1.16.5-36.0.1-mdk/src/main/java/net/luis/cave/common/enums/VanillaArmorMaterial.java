...
public enum VanillaArmorMaterial implements IArmorMaterial {
   ...
   TURTLE("turtle", 25, new int[] {2, 5, 6, 3}, 9, SoundEvents.ITEM_ARMOR_EQUIP_TURTLE, 0.0F, 0.0F, () -> {
   ...
   private VanillaArmorMaterial(String name, int maxDamageFactor, int[] damageReductionAmountArray, int enchantability, SoundEvent soundEvent, 
