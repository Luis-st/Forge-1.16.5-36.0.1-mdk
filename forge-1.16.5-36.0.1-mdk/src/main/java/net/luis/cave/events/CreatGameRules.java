...
public class CreatGameRules {
	...
	public static void DoCommonSetup(FMLCommonSetupEvent event) {
		...
		try { 
			...
			DeferredWorkQueue.runLater(() -> addBooleanGameRule(CaveGameRules.DO_ENDERMAN_TELEPORT));
			DeferredWorkQueue.runLater(() -> addBooleanGameRule(CaveGameRules.DO_ENDERMAN_ATTACK_TELEPORT));
			DeferredWorkQueue.runLater(() -> addBooleanGameRule(CaveGameRules.DO_SHULKER_TELEPORT));
			...
			DeferredWorkQueue.runLater(() -> addBooleanGameRule(CaveGameRules.DO_VILLAGER_FAST_CONVERT));
			DeferredWorkQueue.runLater(() -> addBooleanGameRule(CaveGameRules.DO_WORKTIME_TRADE_RESETING));
			DeferredWorkQueue.runLater(() -> addBooleanGameRule(CaveGameRules.DO_TRADE_REDUCTION));
			DeferredWorkQueue.runLater(() -> addBooleanGameRule(CaveGameRules.DO_PROTECTION_TIME));
			...
			DeferredWorkQueue.runLater(() -> addBooleanGameRule(CaveGameRules.DO_ITEM_DESPAWN));
			DeferredWorkQueue.runLater(() -> addBooleanGameRule(CaveGameRules.DROP_ENDSTAR));
			DeferredWorkQueue.runLater(() -> addBooleanGameRule(CaveGameRules.ITEM_NO_GRAVITY));
			DeferredWorkQueue.runLater(() -> addBooleanGameRule(CaveGameRules.INFINITE_HARVESTING));
