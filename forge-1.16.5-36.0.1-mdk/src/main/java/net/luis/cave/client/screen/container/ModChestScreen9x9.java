...
public class ModChestScreen9x9 extends ContainerScreen<ModChestContainer9x9> implements IHasContainer<ModChestContainer9x9> {

	private static final ResourceLocation CHEST_GUI_TEXTURE = new ResourceLocation("textures/gui/container/generic_54.png");
	private final int inventoryRows;

	public ModChestScreen9x9(ModChestContainer9x9 container, PlayerInventory playerInventory, ITextComponent title) {
