...
public class ModContainerType {
	...
	public static final RegistryObject<ContainerType<ModBarrelContainer>> BARREL = CONTAINERS.register("barrel", 
			() -> IForgeContainerType.create(ModBarrelContainer::new));
