...
public class ModContainerType {
	...
	public static final RegistryObject<ContainerType<ModShulkerBoxContainer>> SHULKER_BOX_CONTAINER = CONTAINERS.register("shulker_box", 
			() -> IForgeContainerType.create(ModShulkerBoxContainer::new));
